    ...
    public class DepartmentsController : Controller
    {
                ...
                catch (DbUpdateConcurrencyException ex)
                {
                    ...
                    else
                    {
                        ...
                        ModelState.AddModelError(string.Empty, "The record you attempted to edit "
                            ...
                            + "edit operation was cancled and the current values in the database "
                            + "have been displayd. If you still want to edit this record, click "
        ...
        public async Task<IActionResult> Delete(int? id, bool? concurrencyError)
        {
            ...
            if (concurrencyError.GetValueOrDefault())
            {
                ...
                + "delete operation was cancled and the current values in the database "
                + "have been displayd. If you still want to delete this record, click "
